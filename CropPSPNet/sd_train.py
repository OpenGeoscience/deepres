...
#                                num_workers=cfg['training']['n_workers'])
    ...
    paths = {
        'masks': './satellitedata/patchsd_train/gt/',
        'images': './satellitedata/patchsd_train/rgb',
        'nirs': './satellitedata/patchsd_train/nir',
        'swirs': './satellitedata/patchsd_train/swir',
        'vhs': './satellitedata/patchsd_train/vh',
        'vvs': './satellitedata/patchsd_train/vv',
        'redes': './satellitedata/patchsd_train/rede',
        'ndvis': './satellitedata/patchsd_train/ndvi',
        }

    valpaths = {
        'masks': './satellitedata/patchsd_val/gt/',
        'images': './satellitedata/patchsd_val/rgb',
        'nirs': './satellitedata/patchsd_val/nir',
        'swirs': './satellitedata/patchsd_val/swir',
        'vhs': './satellitedata/patchsd_val/vh',
        'vvs': './satellitedata/patchsd_val/vv',
        'redes': './satellitedata/patchsd_val/rede',
        'ndvis': './satellitedata/patchsd_val/ndvi',
        }
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        nargs="?",
        type=str,
        default="configs/pspnet_crop_sd.yml",
