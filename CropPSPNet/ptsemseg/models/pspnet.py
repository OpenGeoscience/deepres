...
class pspnet(nn.Module):
    ...
    def __init__(
        ...
        self.convbnrelu1_1 = conv2DBatchNormRelu(
            ...
            # Modified by Chengjiang Long
            in_channels=12, k_size=3, n_filters=64, padding=1, stride=2, bias=False 
        )
        ...
        self.cbr_final = conv2DBatchNormRelu(3584, 512, 3, 1, 1, False)  #Changed by Chengjiang Long.
